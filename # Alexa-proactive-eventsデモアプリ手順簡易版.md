...
## 手順
1. [ドキュメント][1]のSkill setup stepsの4まで進める。
...
3. [ドキュメント][1]のSkill setup stepsの5からあとを進める。

[1]:(https://github.com/alexa/alexa-cookbook/tree/master/feature-demos/skill-demo-proactive-events)
